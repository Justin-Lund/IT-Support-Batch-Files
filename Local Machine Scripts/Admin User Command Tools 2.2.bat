...
echo 5. Clear Printer Cache and Restart Print Spooler Service
echo 6. Clear Internet Explorer Cache ^& Locally Cached Credentials
...
IF ERRORLEVEL 6 GOTO ClearIEAndCachedCredentials
IF ERRORLEVEL 5 GOTO Printer
...
echo Credential Manager credentials cleared
echo.
...
title Cache and Cookies Cleared
